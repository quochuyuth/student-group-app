<?php
// Tệp: app/views/auth/register.php (PHIÊN BẢN CỰC ĐẸP)
    ...
    <style>
        * {
        ...
        .auth-left::before {
            ...
            bottom: 0;
            /* GÁN ẢNH TẠI ĐÂY: */
            /* background: url('public/img/register-bg.jpg') center/cover; */
            opacity: 0.15;
            z-index: 0;
        }
                ...
                <div class="card auth-card border-0">
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-5 d-none d-lg-block auth-left">
                            ...
                            <h1>Tham gia ngay!</h1>
                            <p>Trải nghiệm nền tảng học tập thông minh, kết nối với bạn bè và phát triển kỹ năng mỗi ngày</p>
                            
                            <div class="features">
                                <div class="feature-item">
                                    <i class="fas fa-rocket"></i>
                                    <span>Miễn phí<br>100%</span>
                                </div>
                                <div class="feature-item">
                                    <i class="fas fa-shield-alt"></i>
                                    <span>Bảo mật<br>Cao</span>
                                </div>
                                <div class="feature-item">
                                    <i class="fas fa-clock"></i>
                                    <span>Chỉ 30<br>Giây</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7">
                            <div class="auth-right">
                                <h2>Đăng ký</h2>
                                <p class="subtitle">Tạo tài khoản miễn phí ngay! 🚀</p>
                                ...
                                <form action="index.php?action=register" method="POST" id="registerForm">
                                    <div class="form-group">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="text" class="form-control-modern"
                                                id="username" name="username" placeholder="Nhập tên của bạn" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-wrapper">
                                            <input type="password" class="form-control-modern"
                                                id="password" name="password" placeholder="Tạo mật khẩu mạnh" required>
                                    ...
                                    <button type="submit" class="btn btn-modern">
                                        <i class="fas fa-rocket mr-2"></i>Đăng ký ngay
                                    </button>
                                </form>
    ...
    <script>
        ...
        function checkPasswordMatch() {
            ...
            if (password === confirmPassword) {
                passwordMatch.innerHTML = '<i class="fas fa-check-circle mr-1"></i>Mật khẩu khớp!';
                passwordMatch.className = 'password-match show match';
            } else {
                passwordMatch.innerHTML = '<i class="fas fa-times-circle mr-1"></i>Mật khẩu không khớp!';
